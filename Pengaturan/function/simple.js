...
exports.serialize = (kris, msg) => {
  ...
  try {
    ...
    msg.quotedMsg.fromMe = msg.quotedMsg.sender === kris.user.id.split(':')[0]+'@s.whatsapp.net' ? true : false
  ...
  if (msg.key.fromMe) {
    msg.sender = kris.user.id.split(':')[0]+'@s.whatsapp.net'
  }
